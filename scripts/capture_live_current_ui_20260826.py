...
SOURCE_SHA = "faab8fb19c20eacd3594d5dbad67758aa194f06d"
...
def _register_windows_fonts(app: QApplication) -> None:
    ...
    # Re-resolve the already-installed stylesheet after native fonts are registered.
...
def _capture_all(app: QApplication) -> None:
    ...
    manifest = {
        ...
        "capture_branch": "capture/current-ui-20260826-1736",
...
def main() -> int:
    ...
    # desktop_app.main() constructs the real current program, starts its normal supervisors,
    # installs the current settings secondary navigation and all current UI controllers.
