...
- Baseline: `develop/pathena-next@8de698904c98cb50de327e805ae8e9b600df11ea`.
- Error branch pre-sync head: `61a65244ecd31797f47b7af1a454c3188193e2d5`.
- History-preserving NON-FORCE synchronization: `71ffb960d2641a3c3aa4ca80adce66b8072008a9`, parents prior Error head + exact Develop; Error-owned canonical docs are restored immediately after synchronization.
- Relevant Backend head: `e7e8d46e4d1011ec5586367f086c1571fe2a1267`.
- Relevant Spec/Core head: `a4180a04a2e2f1e3abacdf62af954775c1bd5058`.
- Relevant UI head: `81b8d6c2c250a412bb2947b2b356d9111c10b995`.
...
- Backend `postmerge/backend@e7e8d46e4d1011ec5586367f086c1571fe2a1267`, canonical Quality `34039538125 = success`: Local install smoke PASS; Python 3.12 Validator PASS, Ruff PASS, mypy PASS, full pytest PASS; Linux storage and API runtime path-boundary regressions PASS; Windows locality/storage and API runtime path-boundary regressions PASS. No error-ledger signature is present.
- Spec/Core `postmerge/spec-core@a4180a04a2e2f1e3abacdf62af954775c1bd5058`, canonical Quality `34038748816 = success`. No error-owned failure is established.
- UI `postmerge/ui@81b8d6c2c250a412bb2947b2b356d9111c10b995`, canonical Quality `34040342678` is pending; no failure evidence exists yet.
- Current Develop `8de698904c98cb50de327e805ae8e9b600df11ea` has no exact completed canonical Quality observed in this scan and is not promotion-ready by Error criteria.
