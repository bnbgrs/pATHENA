...
| 06 | System | `VISUAL_REFERENCE_PENDING` | Real local runtime/core/provider/storage/backup state; keyboard-selectable System detail focus presentation is implemented under `UI-GAP-0040` pending canonical verification | `IMPLEMENTED_PENDING_VERIFY` | `4cba0e0235ea5094f9f39b4d3f615879ca4362df` |
