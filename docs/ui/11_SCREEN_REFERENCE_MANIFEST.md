...
| 04 | Jobs | `VISUAL_REFERENCE_PENDING` | Real job state and controls; UI-GAP-0073 progress/status product-language slice is exact-green and Integrator-ready | `IMPLEMENTED_PENDING_VISUAL_REVIEW` | `352b4c72c39d5cafe866c604a050a1b93df71940` |
