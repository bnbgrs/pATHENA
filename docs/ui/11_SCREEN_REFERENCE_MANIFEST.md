...
| 04 | Jobs | `VISUAL_REFERENCE_PENDING` | Real durable-job state and controls; no fabricated queue state; read-only job detail reader has an explicit canonical keyboard-focus candidate under `UI-GAP-0036` | `IMPLEMENTED_PENDING_VERIFY` | `8ae0f51e0637e75d7619e7fb9c4fe65679c6f626` |
