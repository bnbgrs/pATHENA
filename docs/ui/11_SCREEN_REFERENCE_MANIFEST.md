...
| 06 | System | `VISUAL_REFERENCE_PENDING` | Real local runtime/core/provider/storage/backup state; keyboard-selectable System detail focus is technically verified; keyboard-selectable runtime status values now have an explicit focus candidate under `UI-GAP-0041` | `IMPLEMENTED_PENDING_VERIFY` | `36b3b9441f1202353cab42b867292ff292f8cb4a` |
