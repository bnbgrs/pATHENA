...
| 02 | Library / Knowledge | `VISUAL_REFERENCE_PENDING` | Reduced knowledge workspace with real durable knowledge/claim provenance; canonical memory tab bar has a bounded focused-selected keyboard candidate (`UI-GAP-0031`) pending canonical verification | `IMPLEMENTED_PENDING_VERIFY` | `e18fe9945e805230aa9c1af95202d8b9c81ba822` |
| 03 | Research | `VISUAL_REFERENCE_PENDING` | Real research process/results with restrained hierarchy and provenance | `IMPLEMENTED_PENDING_VISUAL_REVIEW` | `da493c1390192425d50caddc451c1a497027027a` |
| 04 | Jobs | `VISUAL_REFERENCE_PENDING` | Real durable-job state and controls; no fabricated queue state | `IMPLEMENTED_PENDING_VISUAL_REVIEW` | `da493c1390192425d50caddc451c1a497027027a` |
| 05 | Sources / Files | `VISUAL_REFERENCE_PENDING` | Real source/file state with import and provenance surfaces | `IMPLEMENTED_PENDING_VISUAL_REVIEW` | `da493c1390192425d50caddc451c1a497027027a` |
| 06 | System | `VISUAL_REFERENCE_PENDING` | Real local runtime/core/provider/storage/backup state | `IMPLEMENTED_PENDING_VISUAL_REVIEW` | `da493c1390192425d50caddc451c1a497027027a` |
...
| 08 | PALLAS | `VISUAL_REFERENCE_PENDING` | Characteristic but non-dominant, data-driven semantic view based on real Sources/Claims/Knowledge/Research; lifecycle regression technically verified | `IMPLEMENTED_PENDING_VISUAL_REVIEW` | `da493c1390192425d50caddc451c1a497027027a` |
| 09 | Command Palette / Help | `VISUAL_REFERENCE_PENDING` | Keyboard-first command/search surface backed by real capabilities; command query inherits canonical `QLineEdit:focus`; F1 read-only help content deliberately receives focus and now has explicit verified focus presentation (`UI-GAP-0030`) | `IMPLEMENTED_PENDING_VISUAL_REVIEW` | `f09406daab9440ee77a06e907add84280b3ae936` |
| 10 | Grounded Chat / Evidence & Activity | `VISUAL_REFERENCE_PENDING` | Contextual evidence, claims, sources and activity without synthesized provenance; hierarchy/copy and contextual visibility technically verified | `IMPLEMENTED_PENDING_VISUAL_REVIEW` | `da493c1390192425d50caddc451c1a497027027a` |
| 11 | Startup / Empty / Disconnected state | `VISUAL_REFERENCE_PENDING` | Quiet local-first startup and truthful unavailable/empty states | `IMPLEMENTED_PENDING_VISUAL_REVIEW` | `da493c1390192425d50caddc451c1a497027027a` |
