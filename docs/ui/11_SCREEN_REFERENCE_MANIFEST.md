...
| 07 | Settings | `VISUAL_REFERENCE_PENDING` | Local-model/context/output/reasoning controls with reduced presentation; Local Core state is explicitly not Internet-access state; failed Core refresh metadata reset is awaiting canonical verification | `IMPLEMENTED_PENDING_VERIFY` | `d7e85654db03eb21da35a5fa06d3bdf94cb4a1a5` |
