...
| 05 | Sources / Files | `VISUAL_REFERENCE_PENDING` | Real source/file state with import and provenance surfaces; source-list focused-current keyboard presentation is verified under `UI-GAP-0038`; read-only source detail focus is implemented under `UI-GAP-0039` pending canonical verification | `IMPLEMENTED_PENDING_VERIFY` | `57636da80d3f3db586d1d728b4e6d39dd11896bd` |
| 06 | System | `VISUAL_REFERENCE_PENDING` | Real local runtime/core/provider/storage/backup state | `IMPLEMENTED_PENDING_VISUAL_REVIEW` | `b1537fc138560fe85d4d97cf76c887b92e63c8f4` |
