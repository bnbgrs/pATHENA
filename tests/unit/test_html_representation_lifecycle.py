...
def test_keyboard_interrupt_marks_html_processing_run_cancelled() -> None:
    sources = _Sources()
    runs = _Runs()
    service = SourceHtmlRepresentationService(
        ...
        representation_store=cast(HtmlNativeTextRepresentationStore, object()),
