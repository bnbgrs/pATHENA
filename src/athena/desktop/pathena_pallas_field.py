...
class _PallasNodeItem(QGraphicsEllipseItem):
    ...
    def paint(
        ...
        # Selection and keyboard focus already have a semantic circular outline.
        # Strip Qt's default rectangular selection/focus chrome so the field
        # communicates one deliberate state instead of two competing ones.
