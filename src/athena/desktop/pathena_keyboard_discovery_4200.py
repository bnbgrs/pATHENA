...
_TARGETS: tuple[KeyboardTarget, ...] = (
    KeyboardTarget(
        ...
        None,
        "composer input",
        "Enter sends; Ctrl+Enter also sends",
        "text-entry",
    ),
    KeyboardTarget(
        None,
        ...
        None,
        "send message",
        "Ctrl+Enter sends from chat; Space activates when focused",
        "action",
    ),
    KeyboardTarget(
        None,
        ...
        "Arrow keys change the focused selection",
        "selection",
    ),
    KeyboardTarget(
        None,
        ...
        None,
        "model selector",
        "Arrow keys change the focused model selection",
        "selection",
    ),
    KeyboardTarget(
        None,
    ...
    KeyboardTarget(
        ...
        "detailsToggle",
        "details toggle",
        "Space toggles when focused; Escape closes an open disclosure",
        "toggle",
    ),
    KeyboardTarget(
        None,
    ...
    KeyboardTarget(
        ...
        None,
        "delete conversation",
        "Space opens the existing deletion preview when focused",
        "action",
    ),
    KeyboardTarget(
        "knowledgeWorkspace",
        ...
        None,
        "knowledge search",
        "Type to filter canonical memory",
        "text-entry",
    ),
    KeyboardTarget(
        "knowledgeWorkspace",
        ...
        "Space activates the focused review decision",
        "decision",
    ),
    KeyboardTarget(
        "knowledgeWorkspace",
    ...
    KeyboardTarget(
        ...
        None,
        "research query",
        "Enter queues the typed research question",
        "text-entry",
    ),
    KeyboardTarget(
        "researchWorkspace",
    ...
    KeyboardTarget(
        ...
        None,
        "cancel research",
        "Space activates the focused cancellation action",
        "decision",
    ),
    KeyboardTarget(
        "jobsWorkspace",
    ...
    KeyboardTarget(
        ...
        None,
        "import file",
        "Space opens the existing file picker when focused",
        "action",
    ),
    KeyboardTarget(
        "filesWorkspace",
...
def apply_ui_refinements_4101_4200(window: QWidget) -> tuple[int, ...]:
    ...
    window.setProperty(
        "pathenaKeyboardDiscoveryTargetCount",
