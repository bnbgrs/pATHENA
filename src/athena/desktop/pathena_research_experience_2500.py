"""Research experience refinements 2401-2500 for pATHENA.
...
UI_REFINEMENT_TASKS_2401_2500: tuple[str, ...] = tuple(
...
def apply_ui_refinements_2401_2500(window: QWidget) -> tuple[int, ...]:
    ...
    for index, target in enumerate(_RESEARCH_TARGETS):
        ...
        if found is None:
            continue
        found.setProperty("pathenaResearch2500", True)
        start = 2401 + index * len(_RESEARCH_REFINEMENTS)
