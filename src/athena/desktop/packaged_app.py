"""Packaged Windows entry point for the native pATHENA desktop shell."""
...
def main(argv: Sequence[str] | None = None) -> int:
    ...
    scheduler_supervisor = DesktopJobSchedulerSupervisor(
        executable=_sibling_executable("pATHENA-Scheduler.exe"),
        parent=app,
    )
