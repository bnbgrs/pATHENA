...
class Palette:
    ...
    # The eleven visual references consistently use a very dark navy field,
    # slightly lifted navy panels and cobalt interaction.  Keep orange as a
    # semantic warning colour instead of using it as global application chrome.
    canvas: str = "#061421"
    surface: str = "#06121F"
