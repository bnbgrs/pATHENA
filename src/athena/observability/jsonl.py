...
class _SecureRotatingFileHandler(RotatingFileHandler):
    ...
    # logging.FileHandler installs this runtime attribute in __init__, but the
    # stdlib typing surface does not expose it. Keep the inherited implementation
    # hook explicit here instead of bypassing FileHandler's cached builtin open.
